...
from SealsWithClubsToFpdb import SealsWithClubs


re_GameInfo = SealsWithClubs.re_GameInfo
re_HandInfo = SealsWithClubs.re_HandInfo
re_PlayerInfo = SealsWithClubs.re_PlayerInfo
re_ButtonPos   = SealsWithClubs.re_ButtonPos
re_CollectPot2  = SealsWithClubs.re_CollectPot
re_Action = SealsWithClubs.re_Action
re_rake = SealsWithClubs.re_rake
